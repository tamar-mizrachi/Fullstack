...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "default", size = "default", ...props }, ref) => {
    ...
    const variantClasses = {
      ...
      outline:
        "border-2 border-gray-300 bg-white text-gray-900 hover:border-purple-500 hover:border-2 hover:text-purple-700",
      secondary:
        "bg-white text-gray-900 border border-gray-200 hover:border-purple-500 hover:border-2 hover:text-purple-700",
